...
puts "user created"
u = User.create!(first_name: "Taylor", last_name: "Mravic", password: "123456", email: "taylor@myenglishspeech.com", teacher: true)
...
u = User.create!(first_name: "Arnold", last_name: "Palmer", password: "123456", email: "arnoldpal@ap.com", teacher: true)
...
u = User.create!(first_name: "Doug", last_name: "Truman", password: "123456", email: "doug@gitmain.com", teacher: true)
...
puts "user created"
u = User.create!(first_name: "Risako", last_name: "Nagai", password: "123456", email: "risako@renttopetto.com", teacher: false)
