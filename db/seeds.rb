...
u = User.create!(first_name: "Admin", last_name: "Admin", password: "adminn", email: "admin@admin.com", teacher: true)
...
u = User.create!(first_name: "Arnold", last_name: "Palmer", password: "arnold", email: "arnoldpal@ap.com", teacher: true)
...
u = User.create!(first_name: "Douglas", last_name: "Truman", password: "douglas", email: "doug@gitmain.com", teacher: true)
...
u = User.create!(first_name: "Shintaro", last_name: "Suzuki", password: "123456", email:"s.shintaro@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Musashi", last_name: "Inoue", password: "123456", email:"musamiya@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Taro", last_name: "Yamada", password: "123456", email:"tokugawasan@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Nobunaga", last_name: "Kobayashi", password: "123456", email:"odadono@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Masashige", last_name: "Sasaki", password: "123456", email:"masakusu@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Ryuto", last_name: "Hashimoto", password: "123456", email: "hh_007@qoogle.com", teacher: false)
...
u = User.create!(first_name: "Komaki", last_name: "Yamazaki", password: "123456", email: "singuta@qoogle.com", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Yoko", last_name: "Kawamoto", password: "123456", email: "lenonaide@yanoo.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Kumi", last_name: "Maeda", password: "123456", email:"s_voice@yakoo.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Ayumi", last_name: "Fujita", password: "123456", email:"timelessmagic@ioneto.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Mai", last_name: "Okada", password: "123456", email:"expressyourself@ioneto.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Kana", last_name: "Ota", password: "123456", email:"hanakana@mixix.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Aya", last_name: "Ishii", password: "123456", email:"ayaka@hobbie.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Nana", last_name: "Matsuda", password: "123456", email:"nana_77@digilife.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Keiko", last_name: "Tamura", password: "123456", email:"northernriver@rentopetto.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Kana", last_name: "Fujiwara", password: "123456", email:"hashikan@ohoh.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Kanako", last_name: "Nakano", password: "123456", email:"hashikan2@ruby.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Erika", last_name: "Harada", password: "123456", email:"etoda@java.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Mirei", last_name: "Ueda", password: "123456", email:"kirei_mirei@react.co.jp", teacher: false)
...
puts "user created"
u = User.create!(first_name: "Suzu", last_name: "Takeuchi", password: "123456", email:"hisu@node.co.jp", teacher: false)
...
speech_length = rand(60000..180000)
...
s = Speech.new(title: 'Graduation Speech', transcript: ' I am thrilled to welcome the Class of 2022 to our Graduation Party. I can scarcely believe we are graduates it really is a time for a huge celebration. I love the party venue already, it is outstanding!
  ...
  I hope we have the night of our lives!', notes: ' This is my graduation speech, any feedback appreciated. ', length: speech_length,  user_id: users.first.id, training_id: t.id )
...
s = Speech.new(title: 'Kyoto grad address', transcript: 'Welcome to the Graduation Party of a lifetime for the graduating Class of 2022.
  ...
  Congratulations Class of 2022.' , notes: ' Urgent! If possible I would like it done by tomorrow. ', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
s = Speech.new(title: 'Tech Dilema.', transcript: 'It is possible to imagine that human nature, the human intellect, emotions and feelings are completely independent of our technologies; that we are essentially ahistorical beings with one constant human nature that has remained the same throughout history or even pre-history? Sometimes evolutionary psychologists—those who belief human nature was fixed on the Pleistocene Savannah—talk this way. I think this is demonstrably wrong.
  ...
  ' , notes: ' Hi, I would like some help with intonation mainly.', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
s = Speech.new(title: 'Self Introduction.', transcript: 'Hello everyone. My name is Jim Smith, and I am a systems analyst. I have been with the company for 5 years now. I started off as a technician and over the years progressed to my current role.
  ...
  ' , notes: 'If possible I would like it done by tomorrow.', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
s = Speech.new(title: 'Wedding Speech', transcript: 'Ladies and gentlemen, it was said half a century ago that in the future everyone on earth would get 15 minutes of fame once in a lifetime and I guess that this is mine. People have also told me to make these next few minutes escruciatingly embarrassing and to take vengeance of my enemies. Neither will happen.
  ...
  - a thank you to Lizzies bridesmaids and Zacks ushers and to everyone who has worked so hard to make this day special. ', notes: 'Notes', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
s = Speech.new(title: 'Conference Speech', transcript: 'Dear Excellencies, distinguished guests, dear colleagues, ladies and gentlemen,
  ...
  acatech’s answer has been and will be: through innovation.' , notes: ' Urgent! If possible I would like it done by tomorrow.', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
speech_length = rand(60000..180000)
s = Speech.new(title: 'Climate Change Speech', transcript: 'The United Nations panel on climate change projects that the global temperatures will rise 3-10 degrees fahrenheit by the centurys end enough to have the polar caps all but melted. If the ice caps melt, a vast majority of our countries borders will be under water. Monuments and great buildings, as well as homes and lives will be under water, including New York City.
  ...
  The answer is simpler than you may think. You dont have to go miles away from home to protest, or spend masses of money. If you try to follow the few simple steps that I shall now give you, you will have started to help us all.
  ...
  Keeping to the speed limit can also help the environment. The more you speed the more petrol you are going to use, making the pollution higher. Also, SUVs make about six times their own weight in CO2 each year. A small efficient diesel car covering the same distance not only uses much less fuel; it makes two thirds less.
  ...
  Reduce, reuse and recycle. Only buy what you need; dont stock the cupboards with things you may or may not use. Reuse whatever you can, like containers and paper, and recycle what you cannot reuse. It really is as simple as that.
  ...
  ',notes: 'Public speaking is so scary, I need this perfect', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
speech_length = rand(60000..180000)
s = Speech.new(title: 'Appreciation Speech', transcript: 'Amanda and I want to thank all of our guests for taking the time to celebrate with us today. We understand that being here was a special sacrifice for some as there is a Red Sox/Yankees game going on as we speak.
  ...
  ', notes: 'I am so nervious, need your assistance', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
...
s = Speech.new(title: 'Congratulations Speech', transcript: 'Dear colleagues,
  ...
  Today I am grateful to everyone who participated in the realization of the project. I believe that the work that was done within this project deserves an award, as well as everyone who devoted their time and effort to it. This project was a great starting point for a larger one, and I hope that it would ultimately result in an even larger success due to collaboration and creative potential.
   Thank you very much!
  ', notes: 'Please help me', length: speech_length, user_id: users.first.id, training_id: t.id )
file = URI.open('https://res.cloudinary.com/dpyl9bage/video/upload/v1646705662/development/ox3ps4nokhjokwezpdj5pklq72ii.webm')
s.audio.attach(io: file, filename: 'speech_audio.webm', content_type: 'video/webm')
s.save!
puts "Speech created #{s}"
